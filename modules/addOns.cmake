...
function(OF_include_addOn NAME_ADDON)
    ...
    if (EXISTS ${LOCAL_ADDON_PATH})
        ...
        if (EXISTS ${LOCAL_ADDON_PATH}/addon_config.cmake)
            ...
            message(WARNING "Activating local addon ${NAME_ADDON} via generic function. The generic function makes assumptions about the addon's file structure and is not guaranteed to work in all cases.")
    ...
    elseif (EXISTS ${GLOBAL_ADDON_PATH})
        ...
        elseif (EXISTS ${OF_CMAKE_ADDONS}/${NAME_ADDON}.cmake)
            ...
            message(WARNING "Activating ${NAME_ADDON} via generic function. The generic function makes assumptions about the addon's file structure and is not guaranteed to work in all cases.")
            of_load_generic_addon(${GLOBAL_ADDON_PATH} ${NAME_ADDON})
        endif ()
    else ()
        message(WARNING "Addon ${NAME_ADDON} not found.")
    endif ()
endfunction()
